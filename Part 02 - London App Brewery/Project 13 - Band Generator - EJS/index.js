...
app.post("/submit", (req, res) => {
  ...
  var word1 = adj[Math.floor(Math.random() * wordCount)]
  var word2 = noun[Math.floor(Math.random() * wordCount)]
  res.render("index.ejs", {name1: word1, name2: word2});
